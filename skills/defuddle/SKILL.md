---
name: defuddle
description: Strip clutter from web pages before ingesting into the wiki. Removes ads, navigation, headers, footers, and boilerplate, leaving clean readable markdown that saves 40-60% tokens. Used by wiki-ingest as a pre-step for URL ingestion. Triggers on defuddle, clean this page, strip this url, fetch and clean, clean web content before ingesting, strip ads, remove clutter, clean URL content, readable markdown from URL.
---
