---
name: obsidian-bases
description: Create and edit Obsidian Bases (`.base` files) — Obsidian's native database layer for dynamic tables, card views, list views, filters, formulas, and summaries over vault notes. Useful for building dashboards on top of the universal frontmatter (status, type, confidence, provenance). Triggers on create a base, add a base file, obsidian bases, base view, filter notes, formula, database view, dynamic table, task tracker base, reading list base.
---
