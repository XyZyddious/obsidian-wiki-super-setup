...
description: Write correct Obsidian Flavored Markdown — wikilinks, embeds, callouts (including the vault's custom `[!contradiction]`/`[!gap]`/`[!key-insight]`/`[!stale]`), properties (frontmatter), tags, highlights, math, and canvas syntax. Reference when creating or editing any wiki page. Triggers on write obsidian note, obsidian syntax, wikilink, callout, embed, obsidian markdown, wikilink format, callout syntax, embed syntax, obsidian formatting, how to write obsidian markdown.
---
